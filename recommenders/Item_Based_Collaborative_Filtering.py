...
class ICF():
    ...
    input user rating matrix. Then, having the sim_matrix, together with the known user rating matrix,
    ...
    def fit(self, urm, target_playlist, target_tracks, dataset, knn, shrink_factor):
        ...
        sim_matrix = cosine_item(urm, target_list, shrink_factor, knn)
